...
public class BaiduASRDigitalDialog extends BaiduASRDialog {
    ...
    private void initView() {
        ...
        if (mContentRoot != null) {
            ...
            layoutParams.addRule(RelativeLayout.ALIGN_TOP, getResources().getIdentifier("dialog_linear", "id", getPackageName()));
            layoutParams.addRule(RelativeLayout.ALIGN_BOTTOM, getResources().getIdentifier("dialog_linear", "id", getPackageName()));
